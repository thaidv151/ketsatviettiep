...
import { Search, ChevronDown, FileText, Tag, RefreshCcwIcon, SearchIcon } from 'lucide-react'
import { Input, Select, Button } from 'antd'

export type ModuleSearchState = {
  keyword: string
  status: '' | 'true' | 'false'
}
...
type ModuleSearchPanelProps = {
  expanded: boolean
  onToggle: () => void
  form: ModuleSearchState
  onFormChange: (next: ModuleSearchState) => void
  onSearch: () => void
  onReset: () => void
}
